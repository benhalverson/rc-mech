...
describe('App', () => {
  ...
  it('submits a blank drive-session duration as null', () => {
    ...
    (fixture.componentInstance as any).cars.set([workshopCar]);
    (fixture.componentInstance as any).openCar(workshopCar);
    http.expectOne((request) => request.url === '/api/v1/cars/car-1/components').flush({ components: [], history: true });
    flushDriveSessions();
    fixture.detectChanges();

    (fixture.componentInstance as any).openAddSession();
    (fixture.componentInstance as any).sessionForm.set({
      startedAt: '2026-08-03T10:30', durationMinutes: null, conditions: '', notes: '',
    });
    fixture.detectChanges();
    (fixture.nativeElement.querySelector('.session-form') as HTMLFormElement).dispatchEvent(new Event('submit'));
    ...
    request.flush({ driveSession: { id: 'drive-1', carId: 'car-1', startedAt: '2026-08-03T17:30:00.000Z', durationMinutes: null } });
    flushDriveSessions();
  });
  ...
  it('rejects invalid drive-session durations without submitting', () => {
    ...
    (fixture.componentInstance as any).openAddSession();
    (fixture.componentInstance as any).sessionForm.set({
      startedAt: '2026-08-03T10:30', durationMinutes: 1440.5, conditions: '', notes: '',
    });
    fixture.detectChanges();
    (fixture.nativeElement.querySelector('.session-form') as HTMLFormElement).dispatchEvent(new Event('submit'));
    fixture.detectChanges();

    expect(fixture.nativeElement.textContent).toContain('Duration must be a whole number of minutes between 1 and 1,440.');
