/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e025f49cb06d641f74c2282412ce3bb6)
...
interface __BaseEnv_Env {
	...
	ISSUE_230_PYTHON_CONTAINER: DurableObjectNamespace<import("./prototypes/issue-230/worker").Issue230PythonContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./prototypes/issue-230/worker");
		durableNamespaces: "Issue230PythonContainer";
	}
	interface LocalEnv {
		PHOTOS: R2Bucket;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "ENVIRONMENT">> {}
}
