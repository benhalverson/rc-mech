/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2806dbf2a2d025fcc8143bed2d22a57a)
...
interface __BaseEnv_Env {
	...
	AI: Ai;
	ASSETS: Fetcher;
	APP_URL: "http://localhost:8787" | string;
	ENVIRONMENT: "local" | "production";
	GPU_PROVIDER_ORIGIN: "https://gpu.invalid" | "https://gpu.chassisnotes.com";
	GPU_LEASE_COORDINATOR: DurableObjectNamespace<import("./src/index").GpuLeaseCoordinator>;
	RACE_VIDEO_MEDIA_CONTAINER: DurableObjectNamespace<import("./src/index").RaceVideoMediaContainer>;
	DRIVING_ANALYSIS_WORKFLOW: Workflow<Parameters<import("./src/index").DrivingAnalysisWorkflow['run']>[0]['payload']>;
	RACE_VIDEO_VALIDATION_WORKFLOW: Workflow<Parameters<import("./src/index").RaceVideoValidationWorkflow['run']>[0]['payload']>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "GpuLeaseCoordinator" | "RaceVideoMediaContainer";
	}
	interface LocalEnv {
		PHOTOS: R2Bucket;
		ANALYSIS_MEDIA: R2Bucket;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "ENVIRONMENT" | "GPU_PROVIDER_ORIGIN" | "BETTER_AUTH_SECRET" | "EMAIL_FROM" | "GPU_ACCESS_CLIENT_ID" | "GPU_ACCESS_CLIENT_SECRET" | "INFERENCE_PROFILE_JSON" | "OWNER_EMAIL" | "R2_ACCESS_KEY_ID" | "R2_ACCOUNT_ID" | "R2_SECRET_ACCESS_KEY">> {}
}
