...
export const canEditDriveSession = (value: DriveSessionLifecycle): boolean =>
	value.deletedAt === null;
export const canDeleteDriveSession = (value: DriveSessionLifecycle): boolean =>
	value.deletedAt === null;

export type PresentedDateTime = {
	localDate: string;
	localTime: string;
	timezone: string;
};
