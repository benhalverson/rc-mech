...
export const ownsCar = (carOwnerId: string | null | undefined, authenticatedOwnerId: string): boolean =>
	Boolean(carOwnerId) && carOwnerId === authenticatedOwnerId;

export const carListMode = (archived: string | undefined): "active" | "archived" | "all" | "invalid" => {
